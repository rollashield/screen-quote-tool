...
async function migrateQuoteToEntities(quoteId, quoteRow, quoteData, env) {
  ...
  for (let i = 0; i < screens.length; i++) {
    ...
    `).bind(
      ...
      screen.comparisonPrice != null ? screen.comparisonPrice : null,
      screen.comparisonMaterialPrice != null ? screen.comparisonMaterialPrice : null,
      0, // not excluded
      i,
...
async function handleSaveLineItem(request, env) {
  try {
    ...
    `).bind(
      ...
      data.comparisonPrice != null ? data.comparisonPrice : null,
      data.comparisonMaterialPrice != null ? data.comparisonMaterialPrice : null,
      data.excluded ? 1 : 0,
      data.sortOrder || 0,
